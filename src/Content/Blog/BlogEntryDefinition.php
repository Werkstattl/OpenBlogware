...
class BlogEntryDefinition extends EntityDefinition
{
    public const ENTITY_NAME = 'werkl_blog_entry';
    ...
    {
        return BlogEntryCollection::class;
    }
    ...
    protected function defineFields(): FieldCollection
    {
        return new FieldCollection([
            ...
            (new TranslationsAssociationField(BlogEntryTranslationDefinition::class, 'werkl_blog_entry_id'))->addFlags(new Required()),
