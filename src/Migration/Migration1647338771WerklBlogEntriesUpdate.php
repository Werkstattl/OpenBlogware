...
class Migration1647338771WerklBlogEntriesUpdate extends MigrationStep
{
    ...
    public function updateSchema(Connection $connection): void
    {
        $connection->executeStatement('
            ...
            ADD CONSTRAINT `fk.werkl_blog_entries.cms_page_id`
    ...
    {
        $query
            = 'CREATE TRIGGER werkl_blog_entries_delete AFTER DELETE ON werkl_blog_entries
            FOR EACH ROW
            BEGIN
